...
WORKSPACE = REPO_ROOT / ".panel_build" / "panel1"
OUTPUT_FILE = PANEL_DIR.parent / "Wireless-HeatMapper-Panel1.docx"
...
def assemble_markdown(includes: list[Path], workspace: Path) -> tuple[Path, int]:
    ...
    # Copiar capturas de software similar (antecedentes sección 4.2)
    similar_sw_dir = PANEL_DIR / "img" / "similar-sw"
