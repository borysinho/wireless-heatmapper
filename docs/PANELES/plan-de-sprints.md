...
[Sprint 4 — Heatmap (backend) y Análisis] lasts 14 days
...
[Sprint 4 — Heatmap (backend) y Análisis] starts at [Sprint 3 — Captura WiFi en línea]'s end
[Sprint 5 — IA, Comparación y Reportes] starts at [Sprint 4 — Heatmap (backend) y Análisis]'s end
...
[M4: Heatmap visible en la app] happens at [Sprint 4 — Heatmap (backend) y Análisis]'s end
...
| Sprint 4 | El técnico solicita el heatmap al backend y ve el análisis automático (zonas muertas, CCI/ACI)                                                   | Heatmap renderizado + panel de análisis                                            |
...
\* Sprint 5 tiene 2 semanas → capacidad ~80 hrs.
...
| M4    | Sprint 4   | Imagen heatmap + objeto análisis devueltos por el backend y mostrados en app             |
