## 3.2 Flutter y Dart para el Desarrollo de la Aplicación Móvil

### 3.2.1 Flutter como framework de desarrollo multiplataforma
...
### 3.2.3 BLoC/Cubit para la gestión de estado
