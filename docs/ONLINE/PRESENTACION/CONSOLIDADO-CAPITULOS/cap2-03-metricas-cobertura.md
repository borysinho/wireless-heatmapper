## 2.3 Métricas de Calidad de Señal en Redes Wi-Fi
...
### 2.3.3 CCI — Interferencia Co-Canal (Co-Channel Interference)
...
### 2.3.4 ACI — Interferencia por Canal Adyacente (Adjacent Channel Interference)
...
### 2.3.5 Dynamic Rate Switching (DRS)
