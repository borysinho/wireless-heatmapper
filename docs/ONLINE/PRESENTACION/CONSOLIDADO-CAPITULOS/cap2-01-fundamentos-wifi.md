## 2.1 Redes Inalámbricas de Área Local (WLAN) — Estándar IEEE 802.11

### 2.1.1 Definición y origen del estándar
...
### 2.1.2 Variantes relevantes del estándar
...
### 2.1.3 Arquitectura básica de una WLAN
...
### 2.1.4 Bandas de frecuencia y canales
