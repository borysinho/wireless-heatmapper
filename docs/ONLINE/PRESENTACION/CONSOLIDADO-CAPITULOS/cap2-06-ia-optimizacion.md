## 2.6 Inteligencia Artificial para la Optimización del Posicionamiento de Puntos de Acceso
...
### 2.6.2 Modelo de predicción de RSSI basado en aprendizaje supervisado
...
### 2.6.4 Validación del módulo de IA
