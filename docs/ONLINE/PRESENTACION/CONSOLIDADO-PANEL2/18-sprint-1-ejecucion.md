...
![title PB-09 — Login del Técnico modalidad 100 % en línea](images-staruml/secuencia-pb09-auth.png)

> _Figura 19: Diagrama de secuencia — Login extremo a extremo (PB-09)._

## 10.7.2 Diagrama de secuencia — Crear Proyecto (PB-01)

![title PB-01 — Crear Proyecto de Survey modalidad 100 % en línea](images-staruml/secuencia-pb01-pb10-proyectos.png)
...
![title Diseño de navegación — App Móvil Flutter Sprint 1](images-staruml/navegacion-movil.png)
