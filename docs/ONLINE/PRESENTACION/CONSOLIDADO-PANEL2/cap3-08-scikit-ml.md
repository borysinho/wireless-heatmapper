## scikit-learn y TensorFlow para el Módulo de Inteligencia Artificial

### Selección del framework de machine learning
...
### scikit-learn — Regresión con Bosque Aleatorio
