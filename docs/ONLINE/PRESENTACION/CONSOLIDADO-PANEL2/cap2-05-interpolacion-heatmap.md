## Mapas de Calor y Técnicas de Interpolación Espacial

### El mapa de calor como instrumento de diagnóstico de cobertura
...
### Renderización del heatmap sobre el plano
