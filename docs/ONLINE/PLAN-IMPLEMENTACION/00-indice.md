...
| 11  | [11-sprint-4-heatmap-y-analisis.md](11-sprint-4-heatmap-y-analisis.md)               | Sprint 4: conjuntos de APs, motor de interpolación y análisis automático                |
| 12  | [12-sprint-5-ia-comparacion-y-reportes.md](12-sprint-5-ia-comparacion-y-reportes.md) | Sprint 5: módulo IA, comparación de escenarios y exportación de reportes                |
...
| 18  | [18-reglas-gobernanza-conjuntos-ap-heatmaps.md](18-reglas-gobernanza-conjuntos-ap-heatmaps.md) | Reglas de gobernanza móvil/web para conjuntos de APs, heatmaps, IA y publicación al cliente |
...
| **Sprint 4** | 2 semanas · 26 may–8 jun 2026  | PB-20, PB-05, PB-06                      | Conjuntos de APs + heatmap backend + análisis de cobertura           | Técnico genera heatmaps por propósito, AP individual o subconjunto             | ✅ Implementado |
| **Sprint 5** | 2 semanas · 9–22 jun 2026      | PB-07, PB-12, PB-08                      | IA, comparación de escenarios y reporte PDF                          | Recomendaciones de IA y reporte exportable                                     | ✅ Implementado |
| **Sprint 6** | 2 semanas · 23 jun–6 jul 2026  | PB-15, PB-16, PB-17                      | Portal de cliente + enlace único                                     | Cliente accede al heatmap, análisis y plan AP por enlace                       | ⏳ Planificado  |
...
- **RP4 — Análisis de cobertura:** Sprint 4 (PB-06)
- **RP5 — Optimización IA:** Sprint 5 (PB-07, PB-12)
- **RP6 — Generación de reportes:** Sprint 5 (PB-08)
...
> **Nota de gobernanza móvil/web:** las reglas para conjuntos manuales en móvil, heatmaps operativos, IA restringida a backend/web y publicación por enlace están registradas en [18-reglas-gobernanza-conjuntos-ap-heatmaps.md](18-reglas-gobernanza-conjuntos-ap-heatmaps.md).
