...
**Estado:** Aprobada para implementación por el Product Owner — 20-jun-2026 · Ajustada a gobernanza móvil/web — 20-jun-2026

**Alcance:** Refinamiento técnico de RP5, PB-07 y PB-12, subordinado a las reglas de gobernanza del documento 18
...
A partir de la decisión de gobernanza registrada en [18 — Reglas de Gobernanza para Conjuntos de APs, Heatmaps e IA](../18-reglas-gobernanza-conjuntos-ap-heatmaps.md), este paquete se interpreta como **capacidad técnica de backend/web**. La app móvil puede capturar insumos e inventario RF, pero no solicita, ejecuta ni visualiza alternativas IA no aprobadas.
...
| 06 | [Flujos de experiencia de usuario](06-flujos-de-usuario.md)      | Captura móvil de insumos y gestión web de generación, revisión y publicación |
...
8. La generación IA se solicita únicamente desde web admin o procesos backend autorizados.
9. Toda alternativa IA nace como resultado interno pendiente de revisión y no se publica automáticamente al cliente.
10. El móvil no expone recomendaciones IA, mapas proyectados IA ni comparaciones IA no aprobadas.
...
- [Reglas de gobernanza móvil/web para conjuntos de APs, heatmaps e IA](../18-reglas-gobernanza-conjuntos-ap-heatmaps.md)
