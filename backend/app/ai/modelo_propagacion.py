"""Modelo de propagación Sprint 5.

La línea base usa FSPL simplificado conforme CWNA-107 Tabla 3.1: cada vez que
se duplica la distancia se pierden 6 dB.
"""
...
class ModeloPropagacion:
    ...
    def predecir_rssi(
        ...
        *,
        ...
        penalizacion_banda = {"2.4": 0.0, "5": 4.0, "6": 7.0}.get(banda, 4.0)
        base = self.fspl(distancia_m=distancia_m)
        return round(max(-120.0, base - penalizacion_banda - penalizacion_material_db), 2)
