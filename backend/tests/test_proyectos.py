...
class TestFiltrosFecha:
    """Cobertura de filtros fecha_desde/fecha_hasta."""
    ...
    def test_filtro_fecha_desde_incluye_proyectos_recientes(
        ...
        """fecha_desde=ayer incluye proyectos creados hoy."""
    ...
    def test_filtro_fecha_hasta_incluye_proyectos_pasados(
        ...
        """fecha_hasta=mañana incluye proyectos de hoy."""
        from datetime import datetime, timedelta
    ...
    def test_filtro_fecha_rango_completo(
        ...
        """Rango que incluye hoy retorna proyectos del seed."""
        from datetime import datetime, timedelta
...
class TestClienteEnProyecto:
    """PB-19: cliente retorna como objeto o null."""
